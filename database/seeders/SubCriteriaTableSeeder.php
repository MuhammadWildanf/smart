...
class SubCriteriaTableSeeder extends Seeder
{
    ...
    public function run()
    {
        IntervalCriteria::insert([
            ['criteria_id' => 1, 'range' => '> 540000000', 'value' => 4],
            ['criteria_id' => 1, 'range' => '320000000 - 540000000', 'value' => 3],
            ['criteria_id' => 1, 'range' => '253100000 - 320000000', 'value' => 2],
            ['criteria_id' => 1, 'range' => '150000000 - 253100000', 'value' => 1],
            ...
            ['criteria_id' => 4, 'range' => '1198', 'value' => 1],
            ['criteria_id' => 4, 'range' => '1199', 'value' => 2],
            ['criteria_id' => 4, 'range' => '1200', 'value' => 3],
            ['criteria_id' => 4, 'range' => '1408', 'value' => 4],
            ['criteria_id' => 4, 'range' => '1496', 'value' => 5],
            ['criteria_id' => 4, 'range' => '1498', 'value' => 6],
            ['criteria_id' => 4, 'range' => '1500', 'value' => 7],
            ['criteria_id' => 4, 'range' => '1993', 'value' => 8],
        ]);
    }
}
